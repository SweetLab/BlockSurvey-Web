...
class SignUp extends Component {
  ...
  render() { 
    ...
    return (
      <div className="SignUp">
        ...
        <div>
          <input type="checkbox" name="accept" id="SignUpAccept" onClick={()=>this.setState({accept: !accept})}/>
          <label htmlFor="SignUpAccept" className="checkbox" onClick={()=>this.setState({accept: !accept})}></label>
          <label htmlFor="SignUpAccept" className="AcceptContents" onClick={()=>this.setState({accept: !accept})}>I agree to access the Ethereum Wallet for the use of BlockSurvey.</label>
        </div>
  ...
  SignUpCall() {
    ...
    const { id, pw, pwcheck, email, accept } = this.state;
    ...
    if(idReg.test(id) && pwReg.test(pw) && (pw === pwcheck) && emailReg.test(email) && accept){
